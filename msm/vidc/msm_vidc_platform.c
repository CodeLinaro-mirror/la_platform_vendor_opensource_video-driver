...
static struct msm_vidc_codec_data monaco_codec_data[] =  {
        CODEC_ENTRY(V4L2_PIX_FMT_H264, MSM_VIDC_ENCODER, 0, 675, 320),
        CODEC_ENTRY(V4L2_PIX_FMT_HEVC, MSM_VIDC_ENCODER, 0, 675, 320),
        CODEC_ENTRY(V4L2_PIX_FMT_H264, MSM_VIDC_DECODER, 0, 440, 440),
        CODEC_ENTRY(V4L2_PIX_FMT_HEVC, MSM_VIDC_DECODER, 0, 440, 440),
...
static struct msm_vidc_codec monaco_codecs[] = {
        /* {domain, codec} */
        {DEC, H264}, {DEC, HEVC}, {DEC, VP9},
        {ENC, H264}, {ENC, HEVC},
};
...
static struct msm_vidc_codec_capability monaco_capabilities[] = {
	/* {cap_type, domains, codecs, min, max, step_size, default_value} */
	{CAP_FRAME_WIDTH, DEC, CODECS_ALL, 96, 1920, 1, 1920},
	{CAP_FRAME_HEIGHT, DEC, CODECS_ALL, 96, 1920, 1, 1080},
	{CAP_FRAME_WIDTH, ENC, CODECS_ALL, 128, 1920, 2, 1920},
...
static struct msm_vidc_platform_data monaco_data = {
	.codec_data = monaco_codec_data,
	.codec_data_length =  ARRAY_SIZE(monaco_codec_data),
	.clock_data = NULL,
	.clock_data_length = 0,
	.common_data = monaco_common_data,
	.common_data_length =  ARRAY_SIZE(monaco_common_data),
	.csc_data.vpe_csc_custom_bias_coeff = vpe_csc_custom_bias_coeff,
	.csc_data.vpe_csc_custom_matrix_coeff = vpe_csc_custom_matrix_coeff,
	.csc_data.vpe_csc_custom_limit_coeff = vpe_csc_custom_limit_coeff,
	.efuse_data = NULL,
	...
	.num_vpp_pipes = 0x1,
	.ubwc_config = 0x0,
	.codecs = monaco_codecs,
	.codecs_count = ARRAY_SIZE(monaco_codecs),
	.codec_caps = monaco_capabilities,
	.codec_caps_count = ARRAY_SIZE(monaco_capabilities),
	.vpss_caps = NULL,
	.vpss_caps_count = 0,
};
