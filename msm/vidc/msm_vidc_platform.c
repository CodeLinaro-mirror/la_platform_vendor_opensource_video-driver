...
/* Update with direwolf data */
static struct msm_vidc_codec_data direwolf_codec_data[] =  {
	CODEC_ENTRY(V4L2_PIX_FMT_H264, MSM_VIDC_ENCODER, 25, 675, 320),
	CODEC_ENTRY(V4L2_PIX_FMT_HEVC, MSM_VIDC_ENCODER, 25, 675, 320),
	CODEC_ENTRY(V4L2_PIX_FMT_MPEG2, MSM_VIDC_DECODER, 25, 200, 200),
	CODEC_ENTRY(V4L2_PIX_FMT_H264, MSM_VIDC_DECODER, 25, 200, 200),
...
static struct msm_vidc_codec sm8150_codecs[] = {
	/* {domain, codec} */
...
static struct msm_vidc_codec_capability sm6150_capabilities[] = {
	...
	/* ((3840 * 2176) / 256) * 60 fps */
	{CAP_MBS_PER_SECOND, DEC, CODECS_ALL, 36, 1958400, 1, 489600},
	{CAP_MBS_PER_SECOND, ENC, CODECS_ALL, 36, 1958400, 1, 489600},
	{CAP_FRAMERATE, DOMAINS_ALL, CODECS_ALL, 1, 480, 1, 30},
	{CAP_BITRATE, DEC, CODECS_ALL, 1, 220000000, 1, 20000000},
	{CAP_BITRATE, ENC, CODECS_ALL, 1, 160000000, 1, 20000000},
	{CAP_CABAC_BITRATE, ENC, H264, 1, 100000000, 1, 20000000},
	...
	{CAP_SECURE_FRAME_HEIGHT, DEC, CODECS_ALL, 96, 2160, 1, 1080},
	{CAP_SECURE_FRAME_WIDTH, ENC, CODECS_ALL, 96, 3840, 2, 1920},
	{CAP_SECURE_FRAME_HEIGHT, ENC, CODECS_ALL, 96, 2160, 2, 1080},
        /* (3840 * 2176) / 256 */
...
static struct msm_vidc_common_data direwolf_common_data[] = {
	{
		.key = "qcom,never-unload-fw",
		.value = 1,
	},
...
static struct msm_vidc_ubwc_config_data direwolf_ubwc_data[] = {
	UBWC_CONFIG(1, 1, 1, 0, 0, 0, 8, 32, 16, 0, 0),
};
...
static struct msm_vidc_platform_data direwolf_data = {
	.codec_data = direwolf_codec_data,
	.codec_data_length =  ARRAY_SIZE(direwolf_codec_data),
	.clock_data = NULL,
	.clock_data_length = 0,
	.common_data = direwolf_common_data,
	.common_data_length =  ARRAY_SIZE(direwolf_common_data),
	.csc_data.vpe_csc_custom_bias_coeff = vpe_csc_custom_bias_coeff,
	.csc_data.vpe_csc_custom_matrix_coeff = vpe_csc_custom_matrix_coeff,
	.csc_data.vpe_csc_custom_limit_coeff = vpe_csc_custom_limit_coeff,
	.efuse_data = NULL,
	...
	.vpu_ver = VPU_VERSION_IRIS2,
	.num_vpp_pipes = 0x4,
	.ubwc_config = direwolf_ubwc_data,
	.codecs = default_codecs,
	.codecs_count = ARRAY_SIZE(default_codecs),
