...
#define MAX_BITRATE_V2          100000000
...
static struct msm_platform_core_capability core_data_volcano_v2[] = {
	/* {type, value} */
	{ENC_CODECS, H264 | HEVC | HEIC},
	{DEC_CODECS, H264 | HEVC | VP9 | HEIC},
	{MAX_SESSION_COUNT, 16},
	...
	{MAX_SECURE_SESSION_COUNT, 3},
	{MAX_RT_MBPF, 65280}, /* (8 * ((1920x1088)/256)) */
	{MAX_MBPF, 130560}, /* (16 * ((1920x1088)/256)) */
	/* max_load 1920x1088@60fps*/
	{MAX_MBPS, 489600},
	{MAX_IMAGE_MBPF, 1048576}, /* (16384x16384)/256 */
	{MAX_MBPF_HQ, 8160}, /* ((1920x1088)/256) */
	{MAX_MBPS_HQ, 244800}, /* ((1920x1088)/256)@30fps */
...
static struct msm_platform_inst_capability instance_cap_data_volcano_v2[] = {
	/* {cap, domain, codec,
	 *      min, max, step_or_mask, value,
	 *      v4l2_id,
	 *      hfi_id,
	 ...
	 */
	{BIT_RATE, ENC, H264 | HEVC,
		1, MAX_BITRATE_V2, 1, DEFAULT_BITRATE,
		V4L2_CID_MPEG_VIDEO_BITRATE,
		HFI_PROP_TOTAL_BITRATE,
		CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
			CAP_FLAG_DYNAMIC_ALLOWED},
	...
	{SLICE_MAX_BYTES, ENC, H264 | HEVC,
		MIN_SLICE_BYTE_SIZE, MAX_SLICE_BYTE_SIZE_V2,
		1, MIN_SLICE_BYTE_SIZE,
		V4L2_CID_MPEG_VIDEO_MULTI_SLICE_MAX_BYTES,
		HFI_PROP_MULTI_SLICE_BYTES_COUNT,
		CAP_FLAG_OUTPUT_PORT},
...
static struct msm_vidc_license_data license_data_volcano[] = {
...
static struct freq_table volcano_freq_table_sku2[] = {
	{201600000}
};
...
static const struct msm_vidc_platform_data volcano_data_v0 = {
	...
	.license_data = license_data_volcano,
	.license_data_size = ARRAY_SIZE(license_data_volcano),
};
...
static const struct msm_vidc_platform_data volcano_data_v2 = {
	/* resources dependent on other module */
	.bw_tbl = volcano_bw_table,
	.bw_tbl_size = ARRAY_SIZE(volcano_bw_table),
	.regulator_tbl = volcano_regulator_table,
	...
	/* platform specific resources */
	.freq_tbl = volcano_freq_table_sku2,
	.freq_tbl_size = ARRAY_SIZE(volcano_freq_table_sku2),
	.reg_prst_tbl = volcano_reg_preset_table,
	.reg_prst_tbl_size = ARRAY_SIZE(volcano_reg_preset_table),
	.fwname = "vpu20_2v",
	.pas_id = 9,
	...
	/* caps related resorces */
	.core_data = core_data_volcano_v2,
	.core_data_size = ARRAY_SIZE(core_data_volcano_v2),
	.inst_cap_data = instance_cap_data_volcano_v2,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_volcano_v2),
	.inst_cap_dependency_data = instance_cap_dependency_data_volcano_v0,
	.inst_cap_dependency_data_size = ARRAY_SIZE(instance_cap_dependency_data_volcano_v0),
	.csc_data.vpe_csc_custom_bias_coeff = vpe_csc_custom_bias_coeff,
	.csc_data.vpe_csc_custom_matrix_coeff = vpe_csc_custom_matrix_coeff,
