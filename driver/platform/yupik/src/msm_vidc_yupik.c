...
static const struct msm_platform_core_capability core_data_yupik_v1[] = {
	...
	{MAX_SECURE_SESSION_COUNT, 3},
	{MAX_RT_MBPF, 34816}, /* ((4096x2176)/256) x 1 */
	{MAX_MBPF, 34816}, /* ((4096x2176)/256) x 1 @30fps */
	/* max_load 3840x2176@120fps*/
	/* Concurrency: UHD@30 decode + UHD@30 encode */
	{MAX_MBPS, 1044480}, /* max_load 4096x2176@30fps */
	{MAX_IMAGE_MBPF, 1048576},  /* (16384x16384)/256 */
	{MAX_MBPF_HQ, 8160}, /* ((1920x1088)/256) */
	{MAX_MBPS_HQ, 244800}, /* ((1920x1088)/256)@30fps */
	{MAX_MBPF_B_FRAME, 8160}, /* 1920x1088/256 */
	...
	{FW_UNLOAD, 0},
	{HW_RESPONSE_TIMEOUT, HW_RESPONSE_TIMEOUT_VALUE}, /* 1000 ms */
	{SW_PC_DELAY,         SW_PC_DELAY_VALUE        }, /* 1500 ms (>HW_RESPONSE_TIMEOUT)*/ //its not present in old capability
	{FW_UNLOAD_DELAY,     FW_UNLOAD_DELAY_VALUE    }, /* 3000 ms (>SW_PC_DELAY)*/ // in old one its 1000
	{PAGEFAULT_NON_FATAL, 1},
	{PAGETABLE_CACHING, 0},
	{DCVS, 1},
	{DECODE_BATCH, 1},
...
static struct msm_platform_inst_capability instance_cap_data_yupik_v1[] = {
	/* {cap, domain, codec,
	 *      min, max, step_or_mask, value,
	 *      v4l2_id,
	 *      hfi_id,
	...
	{LOSSLESS_FRAME_HEIGHT, ENC, H264|HEVC/*CODECS_ALL*/, 128, 4096, 2, 1080},
	...
	/* (4096 * 2176) / 256 */
	{SECURE_MBPF, ENC | DEC, H264 | HEVC | VP9, 64, 34816, 1, 8160},
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_yupik_v1[] = {
	/* {cap, domain, codec,
	 *      parents,
	 *      children,
	 *      adjust, set}
...
/* decoder properties */
static const u32 yupik_vdec_psc_avc[] = {
...
static const struct msm_vidc_platform_data yupik_data_v1 = {
	/* resources dependent on other module */
	.bw_tbl = yupik_bw_table,
	.bw_tbl_size = ARRAY_SIZE(yupik_bw_table),
	.regulator_tbl = yupik_regulator_table,
	...
	/* caps related resorces */
	.core_data = core_data_yupik_v1,
	.core_data_size = ARRAY_SIZE(core_data_yupik_v1),
	.inst_cap_data = instance_cap_data_yupik_v1,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_yupik_v1),
	.inst_cap_dependency_data = instance_cap_dependency_data_yupik_v1,
	.inst_cap_dependency_data_size = ARRAY_SIZE(instance_cap_dependency_data_yupik_v1),
	.csc_data.vpe_csc_custom_bias_coeff = vpe_csc_custom_bias_coeff,
	.csc_data.vpe_csc_custom_matrix_coeff = vpe_csc_custom_matrix_coeff,
	.csc_data.vpe_csc_custom_limit_coeff = vpe_csc_custom_limit_coeff,
	.ubwc_config = ubwc_config_yupik,
...
static int msm_vidc_init_data(struct msm_vidc_core *core)
{
	...
	// TODO: Enable efuse when efuse sku vesrions are available

	unsigned int sku_ver = core->platform->data.sku_version;
	d_vpr_h("%s: SKU_version of the target =%u\n", __func__, sku_ver);
	switch (sku_ver) {
	case SKU_VERSION_1:
