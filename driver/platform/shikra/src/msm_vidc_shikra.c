...
static const struct msm_platform_core_capability core_data_shikra[] = {
	...
	{MAX_MBPS, 489600}, /* ((1088x1920)/256)@30fps * 2 sessions */
	{MAX_IMAGE_MBPF, 262144}, /* ((8192x8192)/256) */
	{MAX_MBPF_HQ, 8160}, /* ((1920x1088)/256) */
	{MAX_MBPS_HQ, 244800}, /* (1920 x 1088)@30fps */
	{MAX_MBPF_B_FRAME, 0},
	{MAX_MBPS_B_FRAME, 0},
	{MAX_MBPS_ALL_INTRA, 244800}, /* (1920x1088)/256 MBs@30fps */
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_shikra[] = {
	...
	{ENH_LAYER_COUNT, ENC, HEVC,
		{GOP_SIZE, B_FRAME, BIT_RATE, MIN_QUALITY, OPEN_GOP, SLICE_MODE, LTR_COUNT},
		msm_vidc_adjust_layer_count, msm_vidc_set_layer_count_and_type},

	{ENH_LAYER_COUNT, ENC, H264,
		{GOP_SIZE, B_FRAME, BIT_RATE, MIN_QUALITY, LEVEL, SLICE_MODE, LTR_COUNT},
		msm_vidc_adjust_layer_count, msm_vidc_set_layer_count_and_type},
...
static const u32 shikra_venc_output_prop[] = {
       HFI_PROP_BITSTREAM_RESOLUTION,
       HFI_PROP_CROP_OFFSETS,
};
...
static const struct msm_vidc_platform_data shikra_data = {
	...
	.enc_input_prop = shikra_venc_input_prop,
	.enc_input_prop_size = ARRAY_SIZE(shikra_venc_input_prop),
	.enc_output_prop = shikra_venc_output_prop,
	.enc_output_prop_size = ARRAY_SIZE(shikra_venc_output_prop),
