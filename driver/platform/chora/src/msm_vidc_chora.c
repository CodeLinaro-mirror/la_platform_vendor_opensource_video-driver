...
static const struct msm_platform_core_capability core_data_chora_v0[] = {
	/* {type, value} */
...
static struct msm_platform_inst_capability instance_cap_data_chora_v0[] = {
	/* {cap, domain, codec,
	...
	{MB_CYCLES_VSP, ENC, H264 | HEVC | VP9 | HEIC, 25, 25, 1, 25},
	{MB_CYCLES_VSP, DEC, H264 | HEVC | VP9 | HEIC, 25, 25, 1, 25},
	...
	{MB_CYCLES_FW_VPP, ENC, CODECS_ALL, 166667, 166667, 1, 166667},
	{MB_CYCLES_FW_VPP, DEC, CODECS_ALL, 166667, 166667, 1, 166667},
	...
	{OUTPUT_TX_FENCE_TYPE, DEC, H264 | HEVC | VP9,
		MSM_VIDC_FENCE_NONE, MSM_VIDC_SW_FENCE,
	...
	{BIT_DEPTH, DEC, H264 | HEVC | VP9 | HEIC, BIT_DEPTH_8, BIT_DEPTH_10, 1, BIT_DEPTH_8,
		0,
	...
	{META_SEI_MASTERING_DISP, DEC, HEVC | HEIC,
		MSM_VIDC_META_DISABLE, MSM_VIDC_META_ENABLE | MSM_VIDC_META_RX_INPUT |
	...
	{META_SEI_CLL, ENC, HEVC | HEIC,
		MSM_VIDC_META_DISABLE,
		V4L2_MPEG_MSM_VIDC_ENABLE | MSM_VIDC_META_DYN_ENABLE | MSM_VIDC_META_TX_INPUT,
		0, MSM_VIDC_META_DISABLE,
...
static struct msm_platform_inst_capability instance_cap_data_chora_v1[] = {
	/* {cap, domain, codec,
	 *      min, max, step_or_mask, value,
	 *      v4l2_id,
	 *      hfi_id,
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_chora[] = {
	...
	{ENC_RING_BUFFER_COUNT, ENC, H264,
		{0},
		NULL,
		msm_vidc_set_ring_buffer_count_chora},
...
/* decoder properties */
static const u32 chora_vdec_psc_avc[] = {
...
static const u32 chora_vdec_psc_hevc[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 chora_vdec_psc_vp9[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 chora_vdec_input_properties_avc[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
};

static const u32 chora_vdec_input_properties_hevc[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
};

static const u32 chora_vdec_input_properties_vp9[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
	HFI_PROP_DPB_LIST,
};

static const u32 chora_vdec_output_properties_avc[] = {
...
static const u32 chora_vdec_output_properties_hevc[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_FENCE_OUTPUT,
...
static const u32 chora_vdec_output_properties_vp9[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_FENCE_OUTPUT,
...
static const u32 chora_msm_vidc_ssr_type[] = {
...
static const struct msm_vidc_platform_data chora_data_v0 = {
	...
	.context_bank_tbl = chora_context_bank_table,
	.context_bank_tbl_size = ARRAY_SIZE(chora_context_bank_table),

	/* platform specific resources */
	.reg_prst_tbl = chora_reg_preset_table,
	.reg_prst_tbl_size = ARRAY_SIZE(chora_reg_preset_table),
	...
	.core_data_size = ARRAY_SIZE(core_data_chora_v0),
	.inst_cap_data = instance_cap_data_chora_v0,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_chora_v0),
	...
	.psc_avc_tbl = chora_vdec_psc_avc,
	.psc_avc_tbl_size = ARRAY_SIZE(chora_vdec_psc_avc),
	.psc_hevc_tbl = chora_vdec_psc_hevc,
	.psc_hevc_tbl_size = ARRAY_SIZE(chora_vdec_psc_hevc),
	.psc_vp9_tbl = chora_vdec_psc_vp9,
	.psc_vp9_tbl_size = ARRAY_SIZE(chora_vdec_psc_vp9),
	.dec_input_prop_avc = chora_vdec_input_properties_avc,
	.dec_input_prop_hevc = chora_vdec_input_properties_hevc,
	.dec_input_prop_vp9 = chora_vdec_input_properties_vp9,
	.dec_input_prop_size_avc = ARRAY_SIZE(chora_vdec_input_properties_avc),
	.dec_input_prop_size_hevc = ARRAY_SIZE(chora_vdec_input_properties_hevc),
	.dec_input_prop_size_vp9 = ARRAY_SIZE(chora_vdec_input_properties_vp9),
	.dec_output_prop_avc = chora_vdec_output_properties_avc,
	.dec_output_prop_hevc = chora_vdec_output_properties_hevc,
	.dec_output_prop_vp9 = chora_vdec_output_properties_vp9,
	.dec_output_prop_size_avc = ARRAY_SIZE(chora_vdec_output_properties_avc),
	.dec_output_prop_size_hevc = ARRAY_SIZE(chora_vdec_output_properties_hevc),
	.dec_output_prop_size_vp9 = ARRAY_SIZE(chora_vdec_output_properties_vp9),

	.msm_vidc_ssr_type = chora_msm_vidc_ssr_type,
	.msm_vidc_ssr_type_size = ARRAY_SIZE(chora_msm_vidc_ssr_type),
	.efuse_data = efuse_data_chora,
	.efuse_data_size = ARRAY_SIZE(efuse_data_chora),
	.sku_version = SKU_VERSION_0,
};

static const struct msm_vidc_platform_data chora_data_v1 = {
	/* resources dependent on other module */
	.bw_tbl = chora_bw_table,
	.bw_tbl_size = ARRAY_SIZE(chora_bw_table),
	.pd_tbl = chora_pd_table,
	...
	.core_data_size = ARRAY_SIZE(core_data_chora_v1),
	.inst_cap_data = instance_cap_data_chora_v1,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_chora_v1),
	.inst_cap_dependency_data = instance_cap_dependency_data_chora,
	.inst_cap_dependency_data_size = ARRAY_SIZE(instance_cap_dependency_data_chora),
	.csc_data.vpe_csc_custom_bias_coeff = vpe_csc_custom_bias_coeff,
	.csc_data.vpe_csc_custom_matrix_coeff = vpe_csc_custom_matrix_coeff,
...
int msm_vidc_get_platform_data_chora(struct msm_vidc_core *core)
{
	...
	core->platform->data = chora_data_v0;
	...
	if (core->platform->data.sku_version == SKU_VERSION_1)
		core->platform->data = chora_data_v1;
