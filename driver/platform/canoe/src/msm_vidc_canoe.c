...
int msm_vidc_get_platform_data_canoe(struct msm_vidc_core *core)
{
	...
	/* update version specific data which needs to override the core data */
	if (core->platform->data.sku_version == SKU_VERSION_1) {
		core->platform->data.sku_core_data = core_data_canoe_sku_v1;
		core->platform->data.sku_core_data_size =
			ARRAY_SIZE(core_data_canoe_sku_v1);
		core->platform->data.sku_inst_cap_data =
			instance_cap_data_canoe_sku_v1;
		core->platform->data.sku_inst_cap_data_size =
			ARRAY_SIZE(instance_cap_data_canoe_sku_v1);
		core->platform->data.supports_mmrm = 0;
	}

	if (core->platform->data.sku_version == SKU_VERSION_2) {
		core->platform->data.sku_core_data = core_data_canoe_sku_v2;
		core->platform->data.sku_core_data_size =
			ARRAY_SIZE(core_data_canoe_sku_v2);
		core->platform->data.sku_inst_cap_data =
			instance_cap_data_canoe_sku_v2;
		core->platform->data.sku_inst_cap_data_size =
			ARRAY_SIZE(instance_cap_data_canoe_sku_v2);
		core->platform->data.psc_apv_tbl = NULL;
		core->platform->data.psc_apv_tbl_size = 0;
		core->platform->data.dec_input_prop_apv = NULL;
		core->platform->data.dec_input_prop_size_apv = 0;
	...
	if (core->platform->data.sku_version == SKU_VERSION_3) {
		core->platform->data.sku_core_data = core_data_canoe_sku_v3;
		core->platform->data.sku_core_data_size =
			ARRAY_SIZE(core_data_canoe_sku_v3);
		core->platform->data.sku_inst_cap_data =
			instance_cap_data_canoe_sku_v3;
		core->platform->data.sku_inst_cap_data_size =
			ARRAY_SIZE(instance_cap_data_canoe_sku_v3);
		core->platform->data.subcache_tbl = canoe_subcache_table_sku3;
		core->platform->data.subcache_tbl_size =
			ARRAY_SIZE(canoe_subcache_table_sku3);
		core->platform->data.psc_apv_tbl = NULL;
		core->platform->data.psc_apv_tbl_size = 0;
		core->platform->data.dec_input_prop_apv = NULL;
		core->platform->data.dec_input_prop_size_apv = 0;
