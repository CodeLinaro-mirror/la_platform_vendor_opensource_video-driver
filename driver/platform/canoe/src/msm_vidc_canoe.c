...
static const struct msm_platform_core_capability core_data_canoe_sku_v2[] = {
	/* {type, value} */
...
static const struct msm_platform_core_capability core_data_canoe_sku_v1[] = {
	/* {type, value} */
	{ENC_CODECS, H264 | HEVC | HEIC | APV},
	{DEC_CODECS, H264 | HEVC | VP9 | AV1 | HEIC | APV},
	{MAX_SESSION_COUNT, 16},
...
static const struct msm_platform_core_capability core_data_canoe_sku_v3[] = {
	{ENC_CODECS, H264 | HEVC | HEIC},
	{DEC_CODECS, H264 | HEVC | VP9 | AV1 | HEIC},
	{MAX_SESSION_COUNT, 16},
	{MAX_NUM_720P_SESSIONS, 16},
...
static struct msm_platform_inst_capability instance_cap_data_canoe_sku_v2[] = {
	/* {cap, domain, codec,
	 *      min, max, step_or_mask, value,
	 *      v4l2_id,
	 *      hfi_id,
	 *      flags}
	 */
	{DRV_VERSION, DEC|ENC, H264 | HEVC | VP9 | HEIC | AV1,
		0, INT_MAX, 1, DRIVER_VERSION,
		V4L2_CID_MPEG_VIDC_DRIVER_VERSION},

	{FRAME_WIDTH, DEC, H264 | HEVC | VP9 | HEIC | AV1, 96, 8192, 1, 1920},

	{FRAME_WIDTH, DEC, VP9, 96, 4096, 1, 1920},

	{FRAME_WIDTH, ENC, H264 | HEVC | VP9 | HEIC | AV1, 128, 8192, 1, 1920},

	{FRAME_WIDTH, ENC, HEVC, 96, 8192, 1, 1920},

	{FRAME_WIDTH, ENC, HEIC, 128, 16384, 1, 16384},

	{LOSSLESS_FRAME_WIDTH, ENC, H264 | HEVC | VP9 | HEIC | AV1, 128, 4096, 1, 1920},

	{LOSSLESS_FRAME_WIDTH, ENC, HEVC, 96, 4096, 1, 1920},

	{SECURE_FRAME_WIDTH, DEC, H264 | HEVC | VP9 | HEIC | AV1, 96, 4096, 1, 1920},

	{SECURE_FRAME_WIDTH, ENC, H264 | HEVC | VP9 | HEIC | AV1, 128, 4096, 1, 1920},

	{SECURE_FRAME_WIDTH, ENC, HEVC, 96, 4096, 1, 1920},

	{FRAME_HEIGHT, DEC, H264 | HEVC | VP9 | HEIC | AV1, 96, 8192, 1, 1080},

	{FRAME_HEIGHT, DEC, VP9, 96, 4096, 1, 1080},

	{FRAME_HEIGHT, ENC, H264 | HEVC | VP9 | HEIC | AV1, 128, 8192, 1, 1080},

	{FRAME_HEIGHT, ENC, HEVC, 96, 8192, 1, 1080},

	{FRAME_HEIGHT, ENC, HEIC, 128, 16384, 1, 16384},

	{LOSSLESS_FRAME_HEIGHT, ENC, H264 | HEVC | VP9 | HEIC | AV1, 128, 4096, 1, 1080},

	{LOSSLESS_FRAME_HEIGHT, ENC, HEVC, 96, 4096, 1, 1080},

	{SECURE_FRAME_HEIGHT, DEC, H264 | HEVC | VP9 | HEIC | AV1, 96, 4096, 1, 1080},

	{SECURE_FRAME_HEIGHT, ENC, H264 | HEVC | VP9 | HEIC | AV1, 128, 4096, 1, 1080},
	...
	{MIN_BUFFERS_INPUT, ENC | DEC, H264 | HEVC | VP9 | HEIC | AV1, 0, 64, 1, 4,
		V4L2_CID_MIN_BUFFERS_FOR_OUTPUT,
		0,
		CAP_FLAG_VOLATILE},
	...
	{MIN_BUFFERS_OUTPUT, ENC | DEC, H264 | HEVC | VP9 | HEIC | AV1,
		0, 64, 1, 4,
		V4L2_CID_MIN_BUFFERS_FOR_CAPTURE,
		HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
		CAP_FLAG_OUTPUT_PORT | CAP_FLAG_VOLATILE},
	...
	/* (8192 * 4320) / 256 */
	{MBPF, ENC, H264 | HEVC | VP9 | HEIC | AV1, 64, 138240, 1, 138240},
	...
	{MBPF, DEC, H264 | HEVC | VP9 | HEIC | AV1, 36, 138240, 1, 138240},
	...
	{FRAME_RATE, ENC, H264 | HEVC | VP9 | HEIC | AV1,
		(MINIMUM_FPS << 16), (MAXIMUM_FPS << 16),
		1, (DEFAULT_FPS << 16),
		0,
		HFI_PROP_FRAME_RATE,
	...
	{OPERATING_RATE, ENC, H264 | HEVC | VP9 | HEIC | AV1,
		(MINIMUM_FPS << 16), INT_MAX,
		1, (DEFAULT_FPS << 16)},

	{OPERATING_RATE, DEC, H264 | HEVC | VP9 | HEIC | AV1,
		(MINIMUM_FPS << 16), INT_MAX,
		1, (DEFAULT_FPS << 16),
		V4L2_CID_MPEG_VIDC_OPERATING_RATE,
		0,
	...
	{INPUT_RATE, ENC | DEC, H264 | HEVC | VP9 | HEIC | AV1,
		(MINIMUM_FPS << 16), INT_MAX,
		1, (DEFAULT_FPS << 16)},

	{TIMESTAMP_RATE, ENC | DEC, H264 | HEVC | VP9 | HEIC | AV1,
		(MINIMUM_FPS << 16), INT_MAX,
		1, (DEFAULT_FPS << 16)},
	...
	{MB_CYCLES_VPP, ENC, H264 | HEVC | VP9 | HEIC | AV1, 675, 675, 1, 675},

	{MB_CYCLES_VPP, DEC, H264 | HEVC | VP9 | HEIC | AV1, 200, 200, 1, 200},

	{MB_CYCLES_LP, ENC, H264 | HEVC | VP9 | HEIC | AV1, 320, 320, 1, 320},

	{MB_CYCLES_LP, DEC, H264 | HEVC | VP9 | HEIC | AV1, 200, 200, 1, 200},

	{MB_CYCLES_FW, ENC | DEC, H264 | HEVC | VP9 | HEIC | AV1, 489583, 489583, 1, 489583},

	{MB_CYCLES_FW_VPP, ENC, H264 | HEVC | VP9 | HEIC | AV1, 48405, 48405, 1, 48405},

	{MB_CYCLES_FW_VPP, DEC, H264 | HEVC | VP9 | HEIC | AV1, 66234, 66234, 1, 66234},
	...
	{VFLIP, ENC, H264 | HEVC | VP9 | HEIC | AV1,
		0, 1, 1, 0,
		V4L2_CID_VFLIP,
		HFI_PROP_FLIP,
		CAP_FLAG_OUTPUT_PORT | CAP_FLAG_INPUT_PORT |
	...
	{CONCEAL_COLOR_8BIT, DEC, H264 | HEVC | VP9 | HEIC | AV1, 0x0, 0xFF00FF00FF, 1,
		DEFAULT_VIDEO_CONCEAL_COLOR_BLACK,
		V4L2_CID_MPEG_VIDEO_DEC_CONCEAL_COLOR,
		HFI_PROP_CONCEAL_COLOR_8BIT,
		CAP_FLAG_INPUT_PORT},

	{CONCEAL_COLOR_10BIT, DEC, H264 | HEVC | VP9 | HEIC | AV1, 0x0, 0x3FF03FF03FF, 1,
		DEFAULT_VIDEO_CONCEAL_COLOR_BLACK,
		V4L2_CID_MPEG_VIDEO_DEC_CONCEAL_COLOR,
		HFI_PROP_CONCEAL_COLOR_10BIT,
		CAP_FLAG_INPUT_PORT},
	...
	{BIT_DEPTH, DEC, H264 | HEVC | VP9 | HEIC | AV1, BIT_DEPTH_8, BIT_DEPTH_10, 1, BIT_DEPTH_8,
		0,
		HFI_PROP_LUMA_CHROMA_BIT_DEPTH},
...
static struct msm_platform_inst_capability instance_cap_data_canoe_sku_v1[] = {
	/* {cap, domain, codec,
	 *      min, max, step_or_mask, value,
	 *      v4l2_id,
	 *      hfi_id,
	...
	{FRAME_HEIGHT, ENC, HEVC | APV, 96, 4096, 1, 1080},
	...
	{MBPF, ENC, HEVC | APV, 36, 34816, 1, 34816},
	...
	/* Batch Mode Decode */
	/* TODO: update with new values based on updated voltage corner */
	{BATCH_MBPF, DEC, H264 | HEVC | VP9 | AV1 | APV, 64, 8162, 1, 8162},

	/* (4096 * 2304) / 256 */
	{BATCH_FPS, DEC, H264 | HEVC | VP9 | AV1 | APV, 1, 61, 1, 61},
	...
	{SCALE_FACTOR, DEC, H264 | HEVC | AV1, 0, 1, 0, 1},
...
static struct msm_platform_inst_capability instance_cap_data_canoe_sku_v3[] = {
	/* {cap, domain, codec,
	 *      min, max, step_or_mask, value,
	 *      v4l2_id,
	 *      hfi_id,
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_canoe_sku_v2[] = {
	/* {cap, domain, codec,
	 *      children,
	 *      adjust, set}
	 */
	...
	{TIME_DELTA_BASED_RC, ENC, H264 | HEVC | VP9 | HEIC | AV1,
		{0},
		msm_vidc_adjust_delta_based_rc,
		msm_vidc_set_u32},
	...
	{LEVEL, DEC, H264 | HEVC | VP9 | HEIC | AV1,
		{0},
		NULL,
		msm_vidc_set_u32_enum},
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_canoe_sku_v1[] = {
	/* {cap, domain, codec,
	 *      children,
	 *      adjust, set}
	 */
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_canoe_sku_v3[] = {
	/* {cap, domain, codec,
	 *      children,
	 *      adjust, set}
	 */
...
static struct msm_vidc_efuse_data efuse_data_canoe[] = {
	/*IRIS APV Disable*/
...
static const struct msm_vidc_platform_data canoe_data_sku_v2 = {
	...
	/* caps related resorces */
	.core_data = core_data_canoe_sku_v2,
	.core_data_size = ARRAY_SIZE(core_data_canoe_sku_v2),
	.inst_cap_data = instance_cap_data_canoe_sku_v2,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_canoe_sku_v2),
	.inst_cap_dependency_data = instance_cap_dependency_data_canoe_sku_v2,
	.inst_cap_dependency_data_size = ARRAY_SIZE(instance_cap_dependency_data_canoe_sku_v2),
	.csc_data.vpe_csc_custom_bias_coeff = vpe_csc_custom_bias_coeff,
	.csc_data.vpe_csc_custom_matrix_coeff = vpe_csc_custom_matrix_coeff,
	.csc_data.vpe_csc_custom_limit_coeff = vpe_csc_custom_limit_coeff,
	.ubwc_config = ubwc_config_canoe,
...
static const struct msm_vidc_platform_data canoe_data_sku_v1 = {
	...
	/* caps related resorces */
	.core_data = core_data_canoe_sku_v1,
	.core_data_size = ARRAY_SIZE(core_data_canoe_sku_v1),
	.inst_cap_data = instance_cap_data_canoe_sku_v1,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_canoe_sku_v1),
	.inst_cap_dependency_data = instance_cap_dependency_data_canoe_sku_v1,
	.inst_cap_dependency_data_size = ARRAY_SIZE(instance_cap_dependency_data_canoe_sku_v1),
	.csc_data.vpe_csc_custom_bias_coeff = vpe_csc_custom_bias_coeff,
	.csc_data.vpe_csc_custom_matrix_coeff = vpe_csc_custom_matrix_coeff,
	.csc_data.vpe_csc_custom_limit_coeff = vpe_csc_custom_limit_coeff,
	.ubwc_config = ubwc_config_canoe,
...
static const struct msm_vidc_platform_data canoe_data_sku_v3 = {
	...
	/* caps related resorces */
	.core_data = core_data_canoe_sku_v3,
	.core_data_size = ARRAY_SIZE(core_data_canoe_sku_v3),
	.inst_cap_data = instance_cap_data_canoe_sku_v3,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_canoe_sku_v3),
	.inst_cap_dependency_data = instance_cap_dependency_data_canoe_sku_v3,
	.inst_cap_dependency_data_size = ARRAY_SIZE(instance_cap_dependency_data_canoe_sku_v3),
	.csc_data.vpe_csc_custom_bias_coeff = vpe_csc_custom_bias_coeff,
	.csc_data.vpe_csc_custom_matrix_coeff = vpe_csc_custom_matrix_coeff,
	.csc_data.vpe_csc_custom_limit_coeff = vpe_csc_custom_limit_coeff,
	.ubwc_config = ubwc_config_canoe,
