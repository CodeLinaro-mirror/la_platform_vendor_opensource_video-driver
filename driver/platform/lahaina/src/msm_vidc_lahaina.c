...
#define MAX_BITRATE_V0            220000000
#define DEFAULT_BITRATE         20000000
#define MINIMUM_FPS             1
#define MAXIMUM_FPS_ENC_V0      960
#define MAXIMUM_FPS_DEC_V0      960
#define MAX_QP                  51
...
static struct codec_info codec_data_lahaina[] = {
	{
...
static struct color_format_info color_format_data_lahaina[] = {
	{
...
static struct color_primaries_info color_primaries_data_lahaina[] = {
	{
...
static struct transfer_char_info transfer_char_data_lahaina[] = {
    {
...
static struct matrix_coeff_info matrix_coeff_data_lahaina[] = {
    {
...
static const struct msm_platform_core_capability core_data_lahaina_v0[] = {
	/* {type, value} */
...
static struct msm_platform_inst_capability instance_cap_data_lahaina_v0[] = {
	/* {cap, domain, codec,
	...
	{FRAME_WIDTH, ENC, CODECS_ALL, 128, 8192, 2, 1920},

	{FRAME_WIDTH, ENC, HEIC, 512, 16384, 2, 16384},
	...
	{FRAME_HEIGHT, ENC, CODECS_ALL, 128, 8192, 2, 1080},

	{FRAME_HEIGHT, ENC, HEIC, 512, 16384, 2, 16384},

	{LOSSLESS_FRAME_HEIGHT, ENC, H264|HEVC, 128, 4096, 2, 1080},
	 ...
	 */
	{BATCH_MBPF, DEC, CODECS_ALL, 36, 34816, 1, 34816},
	...
	/* (4096 * 2176) / 256 */
	{SECURE_MBPF, DEC, CODECS_ALL, 36, 36864, 1, 36864},

	{SECURE_MBPF, DEC, CODECS_ALL, 64, 36864, 1, 36864},
	...
	{CABAC_MAX_BITRATE, ENC, H264, 1,
		160000000, 1, 20000000},

	{CAVLC_MAX_BITRATE, ENC, H264, 0,
		MAX_BITRATE_V0, 1, MAX_BITRATE_V0},
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_lahaina_v0[] = {
	/* {cap, domain, codec,
	 *      parents,
	 *      children,
	 *      adjust, set}
...
static const u32 lahaina_msm_vidc_ssr_type[] = {
	HFI_SSR_TYPE_SW_ERR_FATAL,
	HFI_SSR_TYPE_NOC_ERROR,
};

/* Default UBWC config for LPDDR5 */
static struct msm_vidc_ubwc_config_data ubwc_config_lahaina[] = {
	UBWC_CONFIG(8, 32, 16, 0, 1, 1, 1),
};

static struct msm_vidc_format_capability format_data_lahaina = {
	.codec_info = codec_data_lahaina,
	.codec_info_size = ARRAY_SIZE(codec_data_lahaina),
	.color_format_info = color_format_data_lahaina,
	.color_format_info_size = ARRAY_SIZE(color_format_data_lahaina),
	.color_prim_info = color_primaries_data_lahaina,
	.color_prim_info_size = ARRAY_SIZE(color_primaries_data_lahaina),
	.transfer_char_info = transfer_char_data_lahaina,
	.transfer_char_info_size = ARRAY_SIZE(transfer_char_data_lahaina),
	.matrix_coeff_info = matrix_coeff_data_lahaina,
	.matrix_coeff_info_size = ARRAY_SIZE(matrix_coeff_data_lahaina),
};

/* name, min_kbps, max_kbps */
static const struct bw_table lahaina_bw_table[] = {
...
/* name, hw_trigger */
static const struct regulator_table lahaina_regulator_table[] = {
	{ "iris-ctl", 0 },
	{ "vcodec",   1 },
};

/* name, clock id, scaling */
static const struct clk_table lahaina_clk_table[] = {
	{ "gcc_video_axi0",     GCC_VIDEO_AXI0_CLK,         0 },
	{ "core_clk",           VIDEO_CC_MVS0C_CLK,        1 },
	{ "vcodec_clk",         VIDEO_CC_MVS0_CLK,        1 },
};

static const struct clk_rst_table lahaina_clk_reset_table[] = {
	{ "video_axi_reset",        0  },
};

/* name, llcc_id */
static const struct subcache_table lahaina_subcache_table[] = {
        { "vidsc0",     LLCC_VIDSC0 },
}; 


/* name, start, size, secure, dma_coherant, region, dma_mask */
const struct context_bank_table lahaina_context_bank_table[] = {
	{"qcom,vidc,cb-ns",
...
/* freq */
static struct freq_table lahaina_freq_table_sku0[] = {
	{444000000}, {366000000}, {338000000}, {239999999}
};

/* register, value, mask */
static const struct reg_preset_table lahaina_reg_preset_table[] = {
	{ 0xB0088, 0x0,        0x11      },
};

/* decoder properties */
static const u32 lahaina_vdec_psc_avc[] = {
...
static const u32 lahaina_vdec_psc_hevc[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 lahaina_vdec_psc_vp9[] = {
	HFI_PROP_BITSTREAM_RESOLUTION,
	HFI_PROP_CROP_OFFSETS,
	HFI_PROP_LUMA_CHROMA_BIT_DEPTH,
	HFI_PROP_BUFFER_FW_MIN_OUTPUT_COUNT,
...
static const u32 lahaina_vdec_input_properties_avc[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
};

static const u32 lahaina_vdec_input_properties_hevc[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
};

static const u32 lahaina_vdec_input_properties_vp9[] = {
	HFI_PROP_NO_OUTPUT,
	HFI_PROP_SUBFRAME_INPUT,
};

static const u32 lahaina_vdec_output_properties_avc[] = {
...
static const u32 lahaina_vdec_output_properties_hevc[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_FENCE,
...
static const u32 lahaina_vdec_output_properties_vp9[] = {
	HFI_PROP_WORST_COMPRESSION_RATIO,
	HFI_PROP_WORST_COMPLEXITY_FACTOR,
	HFI_PROP_PICTURE_TYPE,
	HFI_PROP_FENCE,
...
static const struct msm_vidc_platform_data lahaina_data_v0 = {
	/* resources dependent on other module */
	.bw_tbl = lahaina_bw_table,
	.bw_tbl_size = ARRAY_SIZE(lahaina_bw_table),
	.regulator_tbl = lahaina_regulator_table,
	.regulator_tbl_size = ARRAY_SIZE(lahaina_regulator_table),
	.clk_tbl = lahaina_clk_table,
	.clk_tbl_size = ARRAY_SIZE(lahaina_clk_table),
	.clk_rst_tbl = lahaina_clk_reset_table,
	.clk_rst_tbl_size = ARRAY_SIZE(lahaina_clk_reset_table),
	.subcache_tbl = lahaina_subcache_table,
	.subcache_tbl_size = ARRAY_SIZE(lahaina_subcache_table), 

	/* populate context bank */
	.context_bank_tbl = lahaina_context_bank_table,
	.context_bank_tbl_size = ARRAY_SIZE(lahaina_context_bank_table),

	/* platform specific resources */
	.freq_tbl = lahaina_freq_table_sku0,
	.freq_tbl_size = ARRAY_SIZE(lahaina_freq_table_sku0),
	.reg_prst_tbl = lahaina_reg_preset_table,
	.reg_prst_tbl_size = ARRAY_SIZE(lahaina_reg_preset_table),
	.fwname = "vpu20_4v",
	.pas_id = 9,
	.supports_mmrm = 0,
	...
	.core_data = core_data_lahaina_v0,
	.core_data_size = ARRAY_SIZE(core_data_lahaina_v0),
	.inst_cap_data = instance_cap_data_lahaina_v0,
	.inst_cap_data_size = ARRAY_SIZE(instance_cap_data_lahaina_v0),
	.inst_cap_dependency_data = instance_cap_dependency_data_lahaina_v0,
	.inst_cap_dependency_data_size = ARRAY_SIZE(instance_cap_dependency_data_lahaina_v0),
	.csc_data.vpe_csc_custom_bias_coeff = vpe_csc_custom_bias_coeff,
	.csc_data.vpe_csc_custom_matrix_coeff = vpe_csc_custom_matrix_coeff,
	.csc_data.vpe_csc_custom_limit_coeff = vpe_csc_custom_limit_coeff,
	.ubwc_config = ubwc_config_lahaina,
	.format_data = &format_data_lahaina,

	/* decoder properties related*/
	.psc_avc_tbl = lahaina_vdec_psc_avc,
	.psc_avc_tbl_size = ARRAY_SIZE(lahaina_vdec_psc_avc),
	.psc_hevc_tbl = lahaina_vdec_psc_hevc,
	.psc_hevc_tbl_size = ARRAY_SIZE(lahaina_vdec_psc_hevc),
	.psc_vp9_tbl = lahaina_vdec_psc_vp9,
	.psc_vp9_tbl_size = ARRAY_SIZE(lahaina_vdec_psc_vp9),
	.dec_input_prop_avc = lahaina_vdec_input_properties_avc,
	.dec_input_prop_hevc = lahaina_vdec_input_properties_hevc,
	.dec_input_prop_vp9 = lahaina_vdec_input_properties_vp9,
	.dec_input_prop_size_avc = ARRAY_SIZE(lahaina_vdec_input_properties_avc),
	.dec_input_prop_size_hevc = ARRAY_SIZE(lahaina_vdec_input_properties_hevc),
	.dec_input_prop_size_vp9 = ARRAY_SIZE(lahaina_vdec_input_properties_vp9),
	.dec_output_prop_avc = lahaina_vdec_output_properties_avc,
	.dec_output_prop_hevc = lahaina_vdec_output_properties_hevc,
	.dec_output_prop_vp9 = lahaina_vdec_output_properties_vp9,
	.dec_output_prop_size_avc = ARRAY_SIZE(lahaina_vdec_output_properties_avc),
	.dec_output_prop_size_hevc = ARRAY_SIZE(lahaina_vdec_output_properties_hevc),
	.dec_output_prop_size_vp9 = ARRAY_SIZE(lahaina_vdec_output_properties_vp9),

	.msm_vidc_ssr_type = lahaina_msm_vidc_ssr_type,
	.msm_vidc_ssr_type_size = ARRAY_SIZE(lahaina_msm_vidc_ssr_type),
};

int msm_vidc_lahaina_check_ddr_type(struct msm_vidc_platform_data *platform_data,
...
static int msm_vidc_init_data(struct msm_vidc_core *core)
{
	...
	int rc = 0;
	dev = &core->pdev->dev;
	core->platform->data = lahaina_data_v0;
	...
	rc = msm_vidc_lahaina_check_ddr_type(&core->platform->data, 0xe);
	if (rc)
		return rc;
