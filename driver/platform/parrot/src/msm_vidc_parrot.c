...
static struct msm_platform_core_capability core_data_parrot_v3[] = {
	/* {type, value} */
	{ENC_CODECS, H264|HEVC|HEIC},
	{DEC_CODECS, H264|HEVC|VP9|HEIC},
	{MAX_SESSION_COUNT, 16},
...
static struct msm_platform_inst_capability instance_data_parrot_v3[] = {
	/* {cap, domain, codec,
	 *      min, max, step_or_mask, value,
	 *      v4l2_id,
	 *      hfi_id,
	...
	{FRAME_WIDTH, DEC, CODECS_ALL, 96, 2560, 1, 1920},
	{FRAME_WIDTH, ENC, CODECS_ALL, 128, 2560, 1, 1920},
	{LOSSLESS_FRAME_WIDTH, ENC, H264|HEVC, 128, 2560, 1, 1920},
	{SECURE_FRAME_WIDTH, DEC, H264|HEVC|VP9, 96, 2560, 1, 1920},
	{SECURE_FRAME_WIDTH, ENC, H264|HEVC, 128, 2560, 1, 1920},
	{FRAME_HEIGHT, DEC, CODECS_ALL, 96, 2560, 1, 1080},
	{FRAME_HEIGHT, ENC, CODECS_ALL, 128, 2560, 1, 1080},
	{LOSSLESS_FRAME_HEIGHT, ENC, H264|HEVC, 128, 2560, 1, 1080},
	{SECURE_FRAME_HEIGHT, DEC, H264|HEVC|VP9, 96, 2560, 1, 1080},
	{SECURE_FRAME_HEIGHT, ENC, H264|HEVC, 128, 2560, 1, 1080},
	{PIX_FMTS, ENC, H264,
		MSM_VIDC_FMT_NV12C,
		MSM_VIDC_FMT_NV21,
		MSM_VIDC_FMT_NV12 | MSM_VIDC_FMT_NV21 | MSM_VIDC_FMT_NV12C,
	...
	/* (2560 * 1440) / 256 */
	{MBPF, ENC, CODECS_ALL, 64, 14400, 1, 14400},
	/* (2560 * 1440) / 256 */
	{MBPF, DEC, CODECS_ALL, 36, 14400, 1, 14400},
	/* (2560 * 1440) / 256 */
	{LOSSLESS_MBPF, ENC, H264|HEVC, 64, 14400, 1, 14400},
	...
	{MIN_BUFFERS_INPUT, ENC|DEC, HEIC, 0, 64, 1, 1,
		V4L2_CID_MIN_BUFFERS_FOR_OUTPUT},
	{MBPF, DEC, HEIC, 36, 25600, 1, 25600 },    /* ((2560x2560)/256) */
	{MBPF, ENC, HEIC, 64, 1048576, 1, 1048576}, /* ((16384x16384)/256) */
	{MBPS, DEC, HEIC, 36, 25600, 1, 25600 },    /* ((2560x2560)/256)@1fps */
	{MBPS, ENC, HEIC, 64, 1048576, 1, 1048576}, /* ((16384x16384)/256)@1fps */
	{BITRATE_MODE, ENC, HEIC,
		V4L2_MPEG_VIDEO_BITRATE_MODE_CQ,
		V4L2_MPEG_VIDEO_BITRATE_MODE_CQ,
...
static struct msm_vidc_efuse_data efuse_data_parrot[] = {
	/* IRIS_DISABLE_4K_Encode - max 2k30 encode */
	EFUSE_ENTRY(0x221C8134, 4, 0x10, 0x2, SKU_VERSION),
...
static int msm_vidc_init_data(struct msm_vidc_core *core)
{
	...
	} else if (platform_data->sku_version == SKU_VERSION_3) {
		platform_data->core_data = core_data_parrot_v3;
		platform_data->core_data_size =
				ARRAY_SIZE(core_data_parrot_v3);
		platform_data->instance_data = instance_data_parrot_v3;
		platform_data->instance_data_size =
				ARRAY_SIZE(instance_data_parrot_v3);
	}
