...
extern int msm_vidc_vpp_clock_voting;
extern int msm_vidc_apv_clock_voting;
extern int msm_vidc_bse_clock_voting;
extern int msm_vidc_tensilica_clock_voting;
