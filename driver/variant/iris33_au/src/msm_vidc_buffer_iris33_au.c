...
static u32 msm_vidc_decoder_comv_size_iris33_au(struct msm_vidc_inst *inst)
{
	u32 size = 0;
...
static u32 msm_vidc_decoder_non_comv_size_iris33_au(struct msm_vidc_inst *inst)
{
	u32 size = 0;
	u32 width = 0, height = 0, num_vpp_pipes = 0;
	struct msm_vidc_core *core = NULL;
...
static u32 msm_vidc_decoder_line_size_iris33_au(struct msm_vidc_inst *inst)
{
	struct msm_vidc_core *core = NULL;
	u32 size = 0;
	u32 width = 0, height = 0, out_min_count = 0, num_vpp_pipes = 0, vpp_delay = 0;
	struct v4l2_format *f = NULL;
	bool is_opb = false;
	u32 color_fmt = 0;
...
static u32 msm_vidc_decoder_partial_data_size_iris33_au(struct msm_vidc_inst *inst)
{
	u32 size = 0;
...
static u32 msm_vidc_decoder_persist_size_iris33_au(struct msm_vidc_inst *inst)
{
	u32 size = 0;
	u32 rpu_enabled = 0;
...
static u32 msm_vidc_decoder_dpb_size_iris33_au(struct msm_vidc_inst *inst)
{
...
static u32 msm_vidc_encoder_comv_size_iris33_au(struct msm_vidc_inst *inst)
{
	u32 size = 0;
...
static u32 msm_vidc_encoder_non_comv_size_iris33_au(struct msm_vidc_inst *inst)
{
	struct msm_vidc_core *core = NULL;
	u32 size = 0;
	u32 width = 0, height = 0, num_vpp_pipes = 0;
...
static u32 msm_vidc_encoder_line_size_iris33_au(struct msm_vidc_inst *inst)
{
	struct msm_vidc_core *core = NULL;
	u32 size = 0;
...
static u32 msm_vidc_encoder_dpb_size_iris33_au(struct msm_vidc_inst *inst)
{
	u32 size = 0;
...
static u32 msm_vidc_encoder_arp_size_iris33_au(struct msm_vidc_inst *inst)
{
	u32 size = 0;
...
static u32 msm_vidc_encoder_vpss_size_iris33_au(struct msm_vidc_inst *inst)
{
	u32 size = 0;
...
static u32 msm_vidc_encoder_output_size_iris33_au(struct msm_vidc_inst *inst)
{
	u32 frame_size = 0;
	struct v4l2_format *f = NULL;
		...
		enum msm_vidc_buffer_type buffer_type)
{
	...
	static const struct msm_vidc_buf_type_handle dec_buf_type_handle[] = {
		...
		{MSM_VIDC_BUF_BIN,             msm_vidc_decoder_bin_size_iris33_au          },
		{MSM_VIDC_BUF_COMV,            msm_vidc_decoder_comv_size_iris33_au         },
		{MSM_VIDC_BUF_NON_COMV,        msm_vidc_decoder_non_comv_size_iris33_au     },
		{MSM_VIDC_BUF_LINE,            msm_vidc_decoder_line_size_iris33_au         },
	...
	static const struct msm_vidc_buf_type_handle enc_buf_type_handle[] = {
		...
		{MSM_VIDC_BUF_OUTPUT,          msm_vidc_encoder_output_size_iris33_au       },
		{MSM_VIDC_BUF_INPUT_META,      msm_vidc_encoder_input_meta_size             },
		{MSM_VIDC_BUF_OUTPUT_META,     msm_vidc_encoder_output_meta_size            },
		{MSM_VIDC_BUF_BIN,             msm_vidc_encoder_bin_size_iris33_au          },
		{MSM_VIDC_BUF_COMV,            msm_vidc_encoder_comv_size_iris33_au         },
		{MSM_VIDC_BUF_NON_COMV,        msm_vidc_encoder_non_comv_size_iris33_au     },
		{MSM_VIDC_BUF_LINE,            msm_vidc_encoder_line_size_iris33_au         },
		{MSM_VIDC_BUF_DPB,             msm_vidc_encoder_dpb_size_iris33_au          },
		{MSM_VIDC_BUF_ARP,             msm_vidc_encoder_arp_size_iris33_au          },
		{MSM_VIDC_BUF_VPSS,            msm_vidc_encoder_vpss_size_iris33_au         },
	};
...
static int msm_vidc_input_min_count_iris33_au(struct msm_vidc_inst *inst)
{
...
static int msm_buffer_delivery_mode_based_min_count_iris33_au(struct msm_vidc_inst *inst,
	uint32_t count)
{
	struct v4l2_format *f = NULL;
	struct msm_vidc_core *core = NULL;
		...
		enum msm_vidc_buffer_type buffer_type)
{
	...
	case MSM_VIDC_BUF_INPUT_META:
		count = msm_vidc_input_min_count_iris33_au(inst);
		break;
	case MSM_VIDC_BUF_OUTPUT:
	case MSM_VIDC_BUF_OUTPUT_META:
		count = msm_vidc_output_min_count(inst);
		count = msm_buffer_delivery_mode_based_min_count_iris33_au(inst, count);
		break;
